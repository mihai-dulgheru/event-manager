...
//        Application.start();
        try {
            ...
            client = proxy.createAccount("Nume Client 1", "Prenume Client 1", "5060101409887", "Adresa Client 1", "Email Client 1", "Telefon Client 1", "client1", "parola1");
            System.out.println(client);
        } catch (SQLException | ClientAgeException e) {
